...
function PropertyCreate() {
    ...
    const createProperty = () => {
        ...
        fetch(`http://localhost:8000/property/create/`, {
            method: 'POST',
            headers: {
            ...
            .then(async response => {
                if (response.status === 201) {
                    ...
                    setGeneralError("Unable to create property");
                }
            })
    ...
    return <div id="cont" class="flex flex-col">
        ...
        <div className="flex">
            <Link to={`/property/manage`} className="w-40 btn btn-error btn-outline fixed bottom-16 right-2/4 z-10" id="lb" >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636" />
                </svg>
            </Link>
            <label className="w-40 btn btn-success btn-outline fixed bottom-16 left-2/4 z-10" id="rb" onClick={createProperty}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
